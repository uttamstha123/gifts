...
import "../productItemCard/productItemCard.css";
...
const FlashSaleCard = ({ product }) => {
  return (
    <div className="productItemCard" style={{ minWidth: "100%" }}>
      ...
      <div className="productItemCard__detail">
        ...
        <h1 className="productItemCard__productName">{product.productName}</h1>
        <Rating className="productItemCard__ratings" value={product.ratings} />
      </div>
    </div>
  );
};
